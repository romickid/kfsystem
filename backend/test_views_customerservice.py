...
class TestCsDisplayrobotreplyShow(TestCase):
    def setUp(self):
        ...
        RobotInfo.objects.create(id=1, enterprise=admin_instance1, question='早安', answer='answer1', keyword='keyword1', weight=1)
        RobotInfo.objects.create(id=2, enterprise=admin_instance1, question='早安上海', answer='answer2', keyword='keyword2', weight=1)
        RobotInfo.objects.create(id=3, enterprise=admin_instance1, question='早安北京', answer='answer3', keyword='keyword3', weight=1)
    ...
    def test(self):
        ...
        json3 = {'customer_input': '早安', 'other': 'other'}
