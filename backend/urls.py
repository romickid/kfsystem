...
urlpatterns = [
    ...
    url(r'^api/admin_find_password_save_data/', views.admin_find_password_save_data),
    ...
    url(r'^api/customerservice_find_password_check_vid/', views.customerservice_find_password_check_vid),
    url(r'^api/customerservice_find_password_save_data/', views.customerservice_find_password_save_data),
